...
<div class="container">
    <div class="box-container">
        ...
        <div class="row">
            <div class="col-sm-8">
            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">Nuevo médico</button>
            </div>
            <div class="col-sm-4">
        ...
        <div class="container mt-3">
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>HU23423</td>
                    <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myAgenda">Agenda</button></td>
                </tr>
                <tr>
                    <td>Mary</td>
                    <td>Moe</td>
                    <td>mary@mail.com</td>
                    <td>HU23423</td>
                    <td><button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myAgenda">Agenda</button></td></td>
                </tr>
                <tr>
                    <td>July</td>
                    <td>Dooley</td>
        ...
        <p>Encuentra toda la información de los Médicos</p>
        <script>
